...
public class Fac_electronic extends javax.swing.JFrame {
DefaultTableModel modelo = new DefaultTableModel();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Fac_electronic.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Fac_electronic().setVisible(true);
            }
        });
    }
